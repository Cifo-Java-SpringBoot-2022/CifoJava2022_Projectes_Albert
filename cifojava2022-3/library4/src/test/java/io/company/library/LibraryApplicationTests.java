...
import io.company.library.model.BookItem;
...
class LibraryApplicationTests {
	...
	void createBooks(){
		...
		BookItem book1 = new BookItem("Anna Karenina",  562, 1896, "BR5GV-5-ERG5-6567");
		BookItem book2 = new BookItem("To the lighthouse", 235, 1626, "56756-DFG2T-554");
		BookItem book3 = new BookItem("Orlando",  203, 2023, "4455645-GWR-456");
		BookItem book4 = new BookItem("In Search of Lost Time", 152, 2023, "4455645-GW1R-456");
	...
	void assignBookLibrary(){
		BookItem book1 = new BookItem("Quardern Gris",  452, 1965, "BR5GV-5-ERG5-6567");
